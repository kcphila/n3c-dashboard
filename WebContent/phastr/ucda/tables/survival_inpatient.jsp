...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	<div id="survival-inpatient"></div>
<script>
$.getJSON("../../phastr/ucda/feeds/survival_inpatient.jsp", function(data){
	...
	table.id="survival-inpatient-table";
	...
	var divContainer = document.getElementById("survival-inpatient");
	divContainer.innerHTML = "";
	divContainer.appendChild(table);

	var data = json['rows'];

	$('#survival-inpatient-table').DataTable( {
    	data: data,
       	paging: true,
    	pageLength: 5,
