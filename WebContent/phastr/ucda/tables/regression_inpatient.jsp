...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	<div id="regression-inpatient"></div>
<script>
$.getJSON("../../phastr/ucda/feeds/regression_inpatient.jsp", function(data){
	...
	table.id="regression-inpatient-table";
	...
	var divContainer = document.getElementById("regression-inpatient");
	divContainer.innerHTML = "";
	divContainer.appendChild(table);

	var data = json['rows'];

	$('#regression-inpatient-table').DataTable( {
    	data: data,
       	paging: true,
    	pageLength: 5,
