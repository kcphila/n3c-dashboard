...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	<div id="survival-liver"></div>
<script>
$.getJSON("../../phastr/ucda/feeds/survival_liver.jsp", function(data){
	...
	var divContainer = document.getElementById("survival-liver");
	divContainer.innerHTML = "";
	divContainer.appendChild(table);

	var data = json['rows'];

	$('#survival-liver-table').DataTable( {
    	data: data,
       	paging: true,
    	pageLength: 5,
