	...
	<div class="container content">
		<div id="data" class="text-max mx-auto">
			<div class="row text-center">
				<div class="col-12">
					<h2>How big is the N3C Data Enclave?</h2>
				</div>
			</div>
		...
		<div id="cohort">
			<div class="row text-center">
				<div class="col-12">
					<h2>Who are the Patients?</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-12">
					<p class="section-description heading-text text-max mx-auto">The N3C Data Enclave contains data both about patients who 
					...
					Below you can explore the general demographic and severity coverage of the N3C. </p>
				</div>	
			</div>
		...
		<div id="sites">
			...
			<div class="row">
				<div class="col-12">
					<p class="section-description heading-text text-max mx-auto">The N3C allows medical sites within the United States to securely transfer 
					anonymized data into the Enclave. The average interval for data transfer from our partners is once a week. 
					To explore the geographic coverage of our current partners, please see the map below.</p>
				</div>
			</div>
		...
		<div id="projects">
			...
			<div class="row">
				<div class="col-12">
					<p class="section-description heading-text text-max mx-auto">N3C projects are internal and user-led initiatives exploring targeted research questions within 
					...
					researchers who wish to join. </p>	
				</div>
			</div>
			<div class="section">
		...
		<div id="publications">
			<div class="row text-center">
				<div class="col-12">
					<h2>What is the Scholarly Output?</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-12">
