...
<style>
	.text-non-hosp div.tabulator-col-title{
		color:  #445ad6 !important;
	}
	.text-hosp div.tabulator-col-title{
		color: #33288d !important;
	}
...
<div class="p-2">
	<div class="d-flex justify-content-center">
		<div class="col-md-6 text-center p-1">
			...
			<svg version="1.1" width="150" id="Layer_1" x="0px" y="0px" viewBox="0 0 42.7 10.4" style="enable-background:new 0 0 42.7 10.4;" xml:space="preserve">
				<style type="text/css">
					.st0{fill:#808080;}
					.st1{fill:#EFEFEF;}
					.st2{fill:black;}
				...
				<rect data-toggle="tooltip" data-placement="top" title="Odd Ratio" id="odds" x="21" y="0" class="st0 info" width="0.7" height="10.4"/>
				<g id="left" data-toggle="tooltip" data-placement="bottom" title="Decreased risk of condition">
					<rect class="st1" width="21" height="10.4"/>
					<rect x="5.8" y="5.2" data-toggle="tooltip" data-placement="top" title="95% confidence interval" class="st0 info" width="9.7" height="0.5"/>
					<circle class="st2 info" data-toggle="tooltip" data-placement="top" title="Estimated risk factor" cx="10" cy="5.4" r="1.5"/>
				</g>
				<g id="right" data-toggle="tooltip" data-placement="bottom" title="Increased risk of condition">
					<rect x="21.6" class="st3" width="21" height="10.4"/>
					<rect x="27.1" y="4.9" class="st0 info" data-toggle="tooltip" data-placement="top" title="95% confidence interval" width="9.7" height="0.5"/>
					<circle class="st2 info" data-toggle="tooltip" data-placement="top" title="Estimated risk factor" cx="34.2" cy="5.2" r="1.5"/>
				</g>
			</svg>
		</div>
	</div>
