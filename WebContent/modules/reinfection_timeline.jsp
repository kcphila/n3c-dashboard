			...
			<div id="reinfection1" class="col-12 col-md-10" >
				...
				<p style="text-align:center;">
					<sql:query var="cases" dataSource="jdbc/N3CPublic">
						...
						from n3c_questions_new.covid_lds_with_reinfection_date_counts_censored where c_date ='2020-03-28'
					</sql:query>
		...
		<div class="row">
			...
			<p style="text-align:center;">
					<sql:query var="cases" dataSource="jdbc/N3CPublic">
						...
						from n3c_questions_new.covid_lds_with_reinfection_date_counts_censored where c_date ='2021-09-06'
					</sql:query>
					<c:forEach items="${cases.rows}" var="row" varStatus="rowCounter">
