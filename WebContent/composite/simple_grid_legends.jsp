				...
				<div class="col col-12 col-md-6 viz-section">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div id="severity_histogram_legend" class="col col-12 col-sm-4 col-md-12 col-lg-4"></div>
						</div>
					</div>
				</div>
				<div class="col col-12 col-md-6 viz-section">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div id="age_histogram_legend" class="col col-12 col-sm-4 col-md-12 col-lg-4"></div>
						</div>
					</div>
				</div>
				<div class="col col-12 col-md-6 viz-section">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div id="race_histogram_legend" class="col col-12 col-sm-4 col-md-12 col-lg-4"></div>
						</div>
					</div>
				</div>
				<div class="col col-12 col-md-6 viz-section">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div id="sex_histogram_legend" class="col col-12 col-sm-4 col-md-12 col-lg-4"></div>
						</div>
					</div>
				</div>
				<div class="col col-12 col-md-6 viz-section">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div id="ethnicity_histogram_legend" class="col col-xs-12 col-sm-4 col-md-12 col-lg-4"></div>
						</div>
					</div>
				</div>
			</div>
