...
<jsp:include page="../block2.jsp">
	<jsp:param name="block" value="all_summary_4" />
	...
	<jsp:param name="datatable" value="all_summary/unknown_vaccination_table.jsp" />
	<jsp:param name="datatable_div" value="all_unknown_vaccination" />
	<jsp:param name="datatable_feed" value="all_summary/feeds/unknown_vaccination.jsp" />
	<jsp:param name="datatable_kpis" value="patient_count" />
</jsp:include>
<script>
	all_summary_4_toggle("severity");
</script>
