...
<jsp:include page="../block2.jsp">
	...
	<jsp:param name="age_filterall2" value="true" />
	...
	<jsp:param name="datatable" value="all_summary/aggregated_table.jsp" />
	<jsp:param name="datatable_div" value="all_aggregated" />
	<jsp:param name="datatable_feed" value="all_summary/feeds/severity.jsp" />
