...
if (title_mode =='pie'){		
	var title = "Severity Percentages of ${param.topic_title} who wern't Prescribed Metformin";
	$("#severity-title2").text(title);
} else if (title_mode == 'bar'){
	var title = "Counts of ${param.topic_title} who wern't Prescribed Metformin by Severity";
	$("#severity-title2").text(title);
} else {
	var title = "Severity Percentages of ${param.topic_title} who wern't Prescribed Metformin";
	$("#severity-title2").text(title);
...
$('#${param.block}-mode-pie').on('mouseup', function() {
	var title = "Severity Percentages of ${param.topic_title} who weren't Prescribed Metformin";
	$("#severity-title2").text(title);
});
