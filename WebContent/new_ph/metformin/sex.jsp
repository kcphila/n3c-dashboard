	...
	<div class="col-12 viz-header-section">
		...
		<div class="btn-group float-right">
			...
			<div class="dropdown-menu dropdown-menu-right">
				<a class="dropdown-item" onclick="${param.block}save_viz_pass_sex('.jpg');">Save as JPG</a>
				<a class="dropdown-item" onclick="${param.block}save_viz_pass_sex('.png');">Save as PNG</a>
				<a class="dropdown-item" onclick="${param.block}save_viz_pass_sex('.svg');">Save as SVG</a>
			</div>
		</div>
	</div>
	<div class="col-12">
...
function ${param.block}save_viz_pass_sex(extension){
