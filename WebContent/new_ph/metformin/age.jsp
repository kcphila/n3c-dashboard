	...
	<div class="col-12 viz-header-section">
		...
		<div class="btn-group float-right">
			...
			<div class="dropdown-menu dropdown-menu-right">
				<a class="dropdown-item" onclick="${param.block}save_viz_pass_age('.jpg');">Save as JPG</a>
				<a class="dropdown-item" onclick="${param.block}save_viz_pass_age('.png');">Save as PNG</a>
				<a class="dropdown-item" onclick="${param.block}save_viz_pass_age('.svg');">Save as SVG</a>
			</div>
		</div>
	</div>
	<div class="col-12">
...
function ${param.block}save_viz_pass_age(extension){
...
function ${param.block}_age_refresh() {
	...
	if (mode =='pie'){		
		localPieChart_new(${param.block}_AgeArray, properties);
	} else if (mode == 'bar'){
