	...
	<div class="col-12 viz-header-section">
		...
		<div class="btn-group float-right">
			...
			<div class="dropdown-menu dropdown-menu-right">
				<a class="dropdown-item" onclick="save_viz_pass_longstatus('.jpg');">Save as JPG</a>
				<a class="dropdown-item" onclick="save_viz_pass_longstatus('.jpg');">Save as PNG</a>
				<a class="dropdown-item" onclick="save_viz_pass_longstatus('.jpg');">Save as SVG</a>
			</div>
		</div>
	</div>
	<div class="col-12">
...
function save_viz_pass_longstatus(extension){
