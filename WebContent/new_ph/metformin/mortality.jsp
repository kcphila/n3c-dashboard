...
<div class="row">
	<div class="col-12 viz-header-section">
		<h2 id="mortality-title" class="viz-title"></h2>
		<div class="btn-group float-right">
			<button type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				<i class="fas fa-download"></i>
			</button>
			<div class="dropdown-menu dropdown-menu-right">
				<a class="dropdown-item" onclick="save_viz_pass_mortality('.jpg');">Save as JPG</a>
				<a class="dropdown-item" onclick="save_viz_pass_mortality('.jpg');">Save as PNG</a>
				<a class="dropdown-item" onclick="save_viz_pass_mortality('.jpg');">Save as SVG</a>
			</div>
		</div>
	</div>
	<div class="col-12">
...
function save_viz_pass_mortality(extension){
