...
<jsp:include page="../block3.jsp">
	...
	<jsp:param name="topic_disease" value="Congestive Heart Failure" />
	...
	<jsp:param name="kpi_filter" value="chfcov_csd" />
	...
	<jsp:param name="datatable_feed" value="hlh/feeds/hlh.jsp?comorbidity=chfcov_csd" />
