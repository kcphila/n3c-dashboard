...
<jsp:include page="../block2.jsp">
	...
	<jsp:param name="block_header" value="Renal%20Disease" />
	<jsp:param name="topic_description" value="secondary_1" />
	<jsp:param name="topic_disease" value="Renal%20Disease" />
	
	<jsp:param name="kpis" value="hlh/kpis.jsp" />
	<jsp:param name="kpi_filter" value="renal_disease" />
	...
	<jsp:param name="datatable_feed" value="hlh/feeds/hlh.jsp?comorbidity=renal_disease" />
