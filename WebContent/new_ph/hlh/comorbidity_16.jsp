...
<jsp:include page="../block3.jsp">
	<jsp:param name="block" value="hlh_16" />
	<jsp:param name="block_header" value="Renal Disease" />
	<jsp:param name="topic_description" value="secondary_1" />
	<jsp:param name="topic_disease" value="Renal Disease" />
	...
	<jsp:param name="kpi_filter" value="renaldiseasecov_csd" />
	...
	<jsp:param name="datatable_div" value="hlh_data_16" />
	<jsp:param name="datatable_feed" value="hlh/feeds/hlh.jsp?comorbidity=renaldiseasecov_csd" />
