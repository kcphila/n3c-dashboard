...
<jsp:include page="../block3.jsp">
	...
	<jsp:param name="topic_disease" value="Cancer" />
	...
	<jsp:param name="kpi_filter" value="cancercovid_csd" />
	...
	<jsp:param name="datatable_div" value="hlh_data_1" />
	<jsp:param name="datatable_feed" value="hlh/feeds/hlh.jsp?comorbidity=cancercovid_csd" />
