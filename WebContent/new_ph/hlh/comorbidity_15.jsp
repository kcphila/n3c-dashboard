...
<jsp:include page="../block3.jsp">
	<jsp:param name="block" value="hlh_15" />
	<jsp:param name="block_header" value="Pulmonary" />
	<jsp:param name="topic_description" value="secondary_1" />
	<jsp:param name="topic_disease" value="Pulmonary" />
	...
	<jsp:param name="kpi_filter" value="pulmonarycov_csd" />
	...
	<jsp:param name="datatable_div" value="hlh_data_15" />
	<jsp:param name="datatable_feed" value="hlh/feeds/hlh.jsp?comorbidity=pulmonarycov_csd" />
