...
<jsp:include page="../block3.jsp">
	<jsp:param name="block" value="hlh_12" />
	...
	<jsp:param name="kpi_filter" value="paralysiscov_csd" />
	...
	<jsp:param name="datatable_div" value="hlh_data_12" />
	<jsp:param name="datatable_feed" value="hlh/feeds/hlh.jsp?comorbidity=paralysiscov_csd" />
