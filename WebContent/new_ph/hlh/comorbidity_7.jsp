...
<jsp:include page="../block2.jsp">
	<jsp:param name="block" value="hlh_7" />
	<jsp:param name="block_header" value="HLH" />
	<jsp:param name="topic_description" value="secondary_1" />
	<jsp:param name="topic_disease" value="HLH" />
	...
	<jsp:param name="datatable_feed" value="hlh/feeds/hlh.jsp?comorbidity=hlh" />
