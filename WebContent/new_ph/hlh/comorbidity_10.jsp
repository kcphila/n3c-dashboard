...
<jsp:include page="../block3.jsp">
	<jsp:param name="block" value="hlh_10" />
	<jsp:param name="block_header" value="Metastasis" />
	<jsp:param name="topic_description" value="secondary_1" />
	<jsp:param name="topic_disease" value="Metastasis" />
	...
	<jsp:param name="kpi_filter" value="metastasiscov_csd" />
	...
	<jsp:param name="datatable_feed" value="hlh/feeds/hlh.jsp?comorbidity=metastasiscov_csd" />
