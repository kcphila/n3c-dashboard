...
<jsp:include page="../block3.jsp">
	<jsp:param name="block" value="hlh_19" />
	<jsp:param name="block_header" value="Diabetes Type 1" />
	<jsp:param name="topic_description" value="secondary_1" />
	<jsp:param name="topic_disease" value="Diabetes Type 1" />
	...
	<jsp:param name="kpi_filter" value="diabetestype1cov_csd" />
	...
	<jsp:param name="datatable_div" value="hlh_data_19" />
	<jsp:param name="datatable_feed" value="hlh/feeds/hlh.jsp?comorbidity=diabetestype1cov_csd" />
	<jsp:param name="datatable_feed" value="hlh/feeds/diabetes_t1.jsp" />
