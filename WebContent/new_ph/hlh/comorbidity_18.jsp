...
<jsp:include page="../block3.jsp">
	<jsp:param name="block" value="hlh_18" />
	<jsp:param name="block_header" value="Stroke" />
	<jsp:param name="topic_description" value="secondary_1" />
	<jsp:param name="topic_disease" value="Stroke" />
	...
	<jsp:param name="kpi_filter" value="strokecov_csd" />
	...
	<jsp:param name="datatable_div" value="hlh_data_18" />
	<jsp:param name="datatable_feed" value="hlh/feeds/hlh.jsp?comorbidity=strokecov_csd" />
