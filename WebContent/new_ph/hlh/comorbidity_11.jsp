...
<jsp:include page="../block3.jsp">
	...
	<jsp:param name="kpi_filter" value="myocardialinfarctioncovid_csd" />
	...
	<jsp:param name="datatable_feed" value="hlh/feeds/hlh.jsp?comorbidity=myocardialinfarctioncovid_csd" />
