	...
	${param.block}_datatable = $('#${param.target_div}-table').DataTable( {
    	...
    	buttons: {
       	...
       	initComplete: function( settings, json ) {
       	 	...
       	 	setTimeout(function() {jQuery('.loading').fadeOut(100); ${param.block}_refreshHistograms(); ${param.block}_medication_overall_refresh(); }, 500);
       	  },
    	pageLength: 10,
    	...
    	order: [[0, 'asc']],
     	columns: [
        	...
        	{ data: 'medication_seq', visible: false}
    	]
	} );
