...
<div class="col-12 viz-header-section">
	...
	<div class="btn-group float-right">
		...
		<div class="dropdown-menu dropdown-menu-right">
			<a class="dropdown-item" onclick="saveVisualization('pos_rolling_graph', '${param.topic_title}.jpg');">Save as JPG</a>
			<a class="dropdown-item" onclick="saveVisualization('pos_rolling_graph', '${param.topic_title}.png');">Save as PNG</a>
			<a class="dropdown-item" onclick="saveVisualization('pos_rolling_graph', '${param.topic_title}.svg');">Save as SVG</a>
		</div>
	</div>
</div>
<div id="pos_rolling">
	<div id="pos_rolling_graph" class="col-12 dash_viz"></div>	
</div>
