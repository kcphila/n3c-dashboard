...
<jsp:include page="../barPieToggle.jsp">
	...
	<jsp:param name="dimension_legend" value="age_legend_10" />
...
function ${param.block}_age_refresh() {
	...
	if (mode =='pie'){		
		localPieChart(${param.block}_AgeArray,"#${param.block}_age_viz", age_legend_10, age_range, 0.5, "Age");
	} else if (mode == 'bar'){
		localHorizontalBarChart_legend(${param.block}_AgeArray, properties);
	} else {
		localPercentageBarChart(${param.block}_AgeArray,"#${param.block}_age_viz", 120, age_range, 0, "Age", age_legend_10);
	};
