							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										...
										data-placement="top" 
										data-content="
										<p>Paxlovid was authorized for use by the FDA on December 22, 2021. This dashboard only includes patients who received a positive COVID test result on or after that date. Additionally, only patients who had a recorded hospitalization after their COVID diagnosis will be shown.</p>
