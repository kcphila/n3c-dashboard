...
<%@ taglib prefix="util" uri="http://icts.uiowa.edu/tagUtil"%>
 ...
 <sql:query var="totals" dataSource="jdbc/N3CPublic">
 	...
 	from (select 
			...
			from n3c_dashboard_ph.longcov_consetvaccmorrac_csd) as foo
</sql:query>
							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										title="<a class='close popover_close' data-dismiss='alert'>&times;</a> Total Long COVID Clinic Patients in View" 
										data-html="true" data-toggle="popover" 
										data-placement="top" 
										data-content="
										<p>Total number of individuals within the view who have had a 
										recorded medical visit to a Long COVID Specialty Clinic on or after 1/1/2019.</p>
										<small class='kpi-small-note'>Even without filters, this total may be less than the total number of long COVID patients within the Enclave due to the suppression of counts less than 20.</small>" aria-describedby="tooltip">
