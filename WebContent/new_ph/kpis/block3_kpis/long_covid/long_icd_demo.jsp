...
<%@ taglib prefix="util" uri="http://icts.uiowa.edu/tagUtil"%>
 ...
 <sql:query var="totals" dataSource="jdbc/N3CPublic">
 	...
 	from (select 
			...
			from n3c_dashboard_ph.longcov_icddemoagemin_csd) as foo
</sql:query>
							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										title="<a class='close popover_close' data-dismiss='alert'>&times;</a> Total Diagnosed Long COVID Patients in View" 
										data-html="true" data-toggle="popover" 
										data-placement="top" 
										data-content="
										<p>Total number of individuals within the view who have Long COVID (U09.9) 
