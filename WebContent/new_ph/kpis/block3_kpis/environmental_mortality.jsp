							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										...
										<p>Even without filters, this total may be less than the total number of environmentally impacted patients within the Enclave due to the suppression of counts less than 20.</p>" aria-describedby="tooltip">
