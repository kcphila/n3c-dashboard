							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										...
										<p>Note: The ICD-10 for PASC (U09.9) was not created until October 1, 2021, and any data using this code will be 
										limited to after this date.</p>" aria-describedby="tooltip">
