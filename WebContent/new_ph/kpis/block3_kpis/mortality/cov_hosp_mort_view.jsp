...
<%@ taglib prefix="util" uri="http://icts.uiowa.edu/tagUtil"%>
 ...
 <sql:query var="totals" dataSource="jdbc/N3CPublic">
 	...
 	from (select 
			...
			from n3c_dashboard_ph.mor_icd10demogrouped_csd) as foo
</sql:query>
							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										title="<a class='close popover_close' data-dismiss='alert'>&times;</a> Total Mortalities After COVID-related Hospitalization in View" 
										data-html="true" data-toggle="popover" 
										data-placement="top" 
										data-content="
										<p>Total number of individuals within the view who have mortality 
										indicated in their EHR after a COVID-related hospitalization.</p>
										<small class='kpi-small-note'>Even without filters, this total may be less than the total number of mortalities after a COVID-related hopsitalization within the Enclave due to the suppression of counts less than 20.</small>" aria-describedby="tooltip">
