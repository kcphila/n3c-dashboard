							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										title="<a class='close popover_close' data-dismiss='alert'>&times;</a> Total Patients with an Environmental Exposure in the Enclave" 
										data-html="true" data-toggle="popover" 
										data-placement="top" 
										data-content="
										<p>Total Number of Individuals within the Enclave who have had an environmental exposure 
										indicated in their EHR.</p>" aria-describedby="tooltip">
	 											<p style="margin-bottom:0px;">Total Environmentally Impacted Patients in Enclave <i class="fas fa-info-circle"></i>
	 											</p> 
 									</a>
 								</span>
 							</td>
