...
<sql:query var="totals" dataSource="jdbc/N3CPublic">
	select 
 		case
			...
			from (
				select patient_count as count from n3c_dashboard_ph.env_allCnt_all_csd where metric = 'Environmentally Impacted COVID+'
			) as foo;
</sql:query>
							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										title="<a class='close popover_close' data-dismiss='alert'>&times;</a> Total COVID+ Patients with an Environmental Exposure in the Enclave" 
										...
										<ul class='low-padding-list'>
											...
											<li>(or) Medical visit in which the ICD-10 code for COVID-19 (U07.1) was recorded</li>
	 											...
	 											<p style="margin-bottom:0px;">Total Envir. Impacted COVID+ Patients in Enclave* <i class="fas fa-info-circle"></i>
	  											<span class="sr-only">, or environmentally impacted patients who have had, a laboratory-confirmed positive COVID-19 PCR or Antigen test, 
