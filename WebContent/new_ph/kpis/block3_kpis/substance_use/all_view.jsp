...
<sql:query var="totals" dataSource="jdbc/N3CPublic">
	select 
 		case
			...
			from (select
					case
						when (num_patients::text = '<20' or num_patients::text is null) then 0
							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										title="<a class='close popover_close' data-dismiss='alert'>&times;</a> Total Patients with a Substance Use Event in View" 
										data-html="true" data-toggle="popover" 
										data-placement="top" 
										data-content="
										<p>Total Number of Individuals within the view who have had a substance use event 
