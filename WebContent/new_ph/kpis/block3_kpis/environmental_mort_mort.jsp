							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										...
										data-placement="top" 
										data-content="
										<strong>Mortality Defined As:</strong>
										<ul style='padding-inline-start: 15px;'>
											<li>Any patient with a date of death in the Enclave.</li>
										</ul>
										<p>Note: this metric is distinct from the Mortality category associated with Severity, as it does not 
										limit deaths to only those suspected to be caused by COVID.</p>" aria-describedby="tooltip">
