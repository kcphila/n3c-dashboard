							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										...
										<small class='kpi-small-note'>Note that if a patient has had multiple comorbidities they will be counted multiple times in this data.</small>" aria-describedby="tooltip">
