...
<sql:query var="totals" dataSource="jdbc/N3CPublic">
	select 
 		case
			...
			from (
				select patient_count as count from n3c_dashboard_ph.cms_cnt_csd where cms_type = 'Medicaid'
			) as foo;
</sql:query>
							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										title="<a class='close popover_close' data-dismiss='alert'>&times;</a> Total Medicaid Linked Patients in the Enclave" 
