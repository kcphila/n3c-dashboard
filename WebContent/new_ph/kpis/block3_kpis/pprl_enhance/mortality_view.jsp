	...
	select 
 		case
			...
			from (select
				  ...
				  from n3c_dashboard_ph.mor_demosev_csd
							...
							<td>
								<span class="tip">
									<a class="viz_secondary_info" 
										title="<a class='close popover_close' data-dismiss='alert'>&times;</a> Total Mortality Linked Patients in View" 
										data-html="true" data-toggle="popover" 
										data-placement="top" 
										data-content="
										<p>Total Number of Individuals within the view who have been linked to Mortality data through PPRL.</p>
