...
<sql:query var="totals" dataSource="jdbc/N3CPublic">
 	select 
		...
		from (
			...
			where observation = 'Type 1 Diabetes conditon before covid'
		) as foo;
</sql:query>
		...
		<div class="panel-primary kpi">
			<div class="kpi-inner">
				<div class="panel-body">
					<table>
						<tr>
							<td>Type 1 Diabetes Before COVID+*</td>
						</tr>
					</table>
				</div>
				<div class="panel-heading kpi_num"><i class="fas fa-users"></i> <span id="${param.block}_diabetes_before_kpi">${row.count}</span></div>
			</div>
		</div>
	</div>
</c:forEach>