...
$.getJSON("<util:applicationRoot/>/new_ph/${param.feed}", function(data){
	...
	${param.block}_datatable = $('#${param.target_div}-table').DataTable( {
    	...
    	order: [[0, 'asc']],
     	columns: [
        	{ data: 'list_of_conditions', visible: true, orderable: true },
        	{ data: 'count', visible: true, orderable: true },
        	{ data: 'no_of_conditions', visible: true, orderable: true },
        	{ data: 'patient_count', visible: true },
        	{ data: 'count_abbrev', visible: false },
           	{ data: 'count_seq', visible: false },
           	{ data: 'list_of_conditions_abbrev', visible: false }
    	]
	} );
