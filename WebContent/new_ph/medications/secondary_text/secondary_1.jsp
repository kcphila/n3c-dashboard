...
<div class="secondary-description">
	<p><strong>Sample:</strong> <span class="tip">
		...
		</span>&nbsp;in the N3C Data Enclave who have had a medical visit on or after 1/1/2019 in which a name 
	and/or code associated with any of the medications of interest was recorded. A patient taking multiple medications at the 
	same time would be included in multiple medication groups. Medication exposures do not mean the patient was given the 
	medication in order to treat COVID-19. A patient may have been on a medication due to a condition that existed prior to 
	their COVID-19 diagnosis. For additional information, <a onclick="${param.block}limitlink(); return false;" href="#limitations-section">see 
	limitations below</a>.</p>
</div>