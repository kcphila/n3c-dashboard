	...
	${param.block}_datatable = $('#${param.target_div}-table').DataTable( {
    	...
    	buttons: {
    	    ...
    	    buttons: [{
    	      ...
    	      text: 'CSV',
    	      filename: 'sotrovimab_medications',
    	      extension: '.csv'
    	    }, {
    	      extend: 'copy',
    	      className: 'btn btn-sm btn-light',
    	...
    	order: [[0, 'asc']],
     	columns: [
        	{ data: 'medications', visible: true, orderable: true, orderData: [7] },
        	{ data: 'severity', visible: true, orderable: true },
        	{ data: 'sotrovimaboccurrence', visible: true, orderable: true },
        	...
        	{ data: 'medications_abbrev', visible: false },
        	{ data: 'medications_seq', visible: false },
        	{ data: 'sotrovimaboccurrence_abbrev', visible: false },
        	{ data: 'sotrovimaboccurrence_seq', visible: false }
    	]
	} );
