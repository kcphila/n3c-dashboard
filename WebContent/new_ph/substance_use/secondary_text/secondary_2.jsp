<div class="secondary-description">
	<p><strong>Sample:</strong> <span class="tip">
				...
				</span>&nbsp;in the N3C Data Enclave who have opioids indicated in their EHR. Patient EHR records are not always complete. 
				The totals within the KPIs are greater than the total number of individuals, as individuals who have multiple opioids within their records will be counted distinctly for each.
