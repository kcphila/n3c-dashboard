<div class="secondary-description">
	<p><strong>Sample:</strong> Patients in the N3C Data Enclave who have both an alcohol-related condition and any <span class="tip">
				...
				</span>&nbsp; indicated in their EHR. Patient EHR records are not always complete. 
				The totals within the KPIs are greater than the total number of individuals, as individuals who experience multiple alcohol-related conditions will be counted distinctly for each.
