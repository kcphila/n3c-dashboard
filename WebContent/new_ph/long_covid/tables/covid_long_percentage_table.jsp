...
$.getJSON("<util:applicationRoot/>/new_ph/${param.feed}", function(data){
	...
	${param.block}_datatable = $('#${param.target_div}-table').DataTable( {
    	...
    	order: [[0, 'asc']],
     	columns: [
        	{ data: 'demographic', visible: true, orderable: true },
        	{ data: 'value', visible: true, orderable: true },
        	{ data: 'total_enclave', visible: true, orderable: true },
        	{ data: 'total_positive', visible: true, orderable: true },
        	{ data: 'positive_percent', visible: true, orderable: true },
        	{ data: 'total_long', visible: true, orderable: true },
        	{ data: 'long_percent', visible: true, orderable: true, orderData: [7] }
    	]
	} );
