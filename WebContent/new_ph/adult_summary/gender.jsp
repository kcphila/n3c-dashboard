...
<jsp:include page="../barPieToggle.jsp">
	...
	<jsp:param name="dimension_range" value="gender_range3" />
	<jsp:param name="dimension_legend" value="gender_legend3" />
...
function ${param.block}_gender_refresh() {
	var properties = {
			...
			min_height: 300,
			ordered: 0,
			colorscale: gender_range3,
			legend_lable: 'Gender',
			legend_data: gender_legend3,
			donutRatio: 0.5
		}
