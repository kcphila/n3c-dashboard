<div class="secondary-description">
	<p>Sample: <span class="tip">
				...
				</span>&nbsp;in the N3C Data Enclave over the age of 18. Data aggregated by Age, Race, Sex, Severity, 
				...
				their vaccination will not be represented in the data. As most vaccination events are not occurring at N3C 
				sites, patients shown here as 'Unknown' may be vaccinated; however, we do not have the records to verify 
				this. Vaccinated patient counts do not indicate that the patient is fully vaccinated. We consider a 
				vaccinated patient to have at least one dose of Pfizer, Moderna, or Johnson & Johnson COVID-19 vaccines. 
				Given that Pfizer and Moderna require two vaccine doses to be considered fully vaccinated, patients shown 
				here may be only partially vaccinated. This same assumption applies to booster shots, as we do not consider 
				shots beyond the first one recorded within the patient's EHR.</p>
</div>
