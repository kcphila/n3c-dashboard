...
<sql:query var="severity" dataSource="jdbc/N3CPublic">
   ...
   FROM ( SELECT severity_abbrev as severity,
           ...
           FROM ( SELECT covid_positive_comorbidities_demo_censored_adult_ped_sum.severity_type AS severity,
                  ...
                  WHERE covid_positive_comorbidities_demo_censored_adult_ped_sum.num_patients <> '<20'::text AND covid_positive_comorbidities_demo_censored_adult_ped_sum.num_patients IS NOT NULL AND ((covid_positive_comorbidities_demo_censored_adult_ped_sum.age_bin = ANY (ARRAY['Unknown'::text, '18-64'::text, '65+'::text])) OR covid_positive_comorbidities_demo_censored_adult_ped_sum.age_bin IS NULL)) foo
