...
function ${param.block}_sex_refresh() {
	...
	// console.log("reached");
   	d3.select("#${param.block}_sex_viz").select("svg").remove(); // console.log(${param.block}_SexStatusArray)
	localHorizontalStackedBarChart(${param.block}_SexStatusArray, properties);	
}
