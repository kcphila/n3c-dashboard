<div class="secondary-description">
	<p>Sample: <span class="tip">
				...
				</span>&nbsp;in the N3C Data Enclave. Patient EHR records are not always complete. <span class="tip">
				...
				</span>&nbsp; for this patient population was obtained from EHR records. There is no guarantee that the reported smoking status of a patient is accurate.</p>
</div>
