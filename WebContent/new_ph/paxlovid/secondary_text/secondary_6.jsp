...
<div class="secondary-description">
	<p><strong>Sample:</strong> <span class="tip">
		...
		</span>&nbsp;in the N3C Data Enclave with diagnosis dates after December 22, 2021 (the date that Paxlovid was authorized for use by the FDA) who had less than 350 visits before their COVID+ diagnosis (visits have been filtered to exclude outliers). 
