...
<div class="secondary-description">
	<p><strong>Sample:</strong> <span class="tip">
		...
		</span>&nbsp;in the N3C Data Enclave with diagnosis dates after December 22, 2021 (the date that Paxlovid was authorized for use by the FDA) who had 100 visits or less after their COVID+ diagnosis (visits have been filtered to exclude outliers). 
