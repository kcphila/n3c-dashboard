...
$.getJSON("<util:applicationRoot/>/new_ph/paxlovid/feeds/less20_condition.jsp", function(data){
	...
	table.id="condition_table_3-table";
	...
	var divContainer = document.getElementById("condition_table_3");
	divContainer.appendChild(table);

	var data = json['rows'];

	${param.block}_datatable = $('#condition_table_3-table').DataTable( {
    	data: data,
