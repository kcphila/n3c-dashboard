...
$.getJSON("<util:applicationRoot/>/new_ph/paxlovid/feeds/topten_drugs.jsp", function(data){
	...
	var divContainer = document.getElementById("drugs_table_1");
	divContainer.appendChild(table);

	var data = json['rows'];

	${param.block}_datatable = $('#drugs_table_1-table').DataTable( {
    	data: data,
