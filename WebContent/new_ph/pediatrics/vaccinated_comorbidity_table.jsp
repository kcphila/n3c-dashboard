	...
	${param.block}_datatable = $('#${param.target_div}-table').DataTable( {
    	...
    	buttons: {
    	    ...
    	    buttons: [{
    	      ...
    	      text: 'CSV',
    	      filename: 'pediatrics_vaccination_and_comorbidities',
    	      extension: '.csv'
    	    }, {
    	      extend: 'copy',
    	      className: 'btn btn-sm btn-light',
    	...
    	order: [[0, 'asc']],
     	columns: [
        	...
        	{ data: 'sex_abbrev', visible: false, orderable: false, searchable: false },
        	{ data: 'sex_seq', visible: false, orderable: false, searchable: false },
