...
SELECT jsonb_pretty(jsonb_agg(done.*)) AS jsonb_pretty
   FROM ( SELECT severity_abbrev as severity,
           ...
           FROM ( SELECT covid_positive_comorbidity_non_grouped_demo_censored.severity_type AS severity,
                    covid_positive_comorbidity_non_grouped_demo_censored.race,
                    ...
                    covid_positive_comorbidity_non_grouped_demo_censored.num_patients AS patient_display,
                        CASE
                  ...
                  WHERE (covid_positive_comorbidity_non_grouped_demo_censored.age_bin in ('0-4', '5-11', '12-15', '16-<18')) ) foo
