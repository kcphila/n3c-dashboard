...
<div class='row card-link'>
	<div class="col col-6">
		<a href='public-health/medication-time-series'>Explore&#8196;<i class="fas fa-angle-right"></i></a>
	</div>
	<div class="col col-6">
		<a tabindex="0" class="btn btn-sm btn-primary" role="button" data-html="true"
			...
			data-content="
				<a href='public-health/medication-time-series/1'>Time Series</a> 
				<br>
				<a href='public-health/medication-time-series/2'>Overall Counts</a>
