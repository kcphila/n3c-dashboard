...
<div class='row card-link'>
	<div class="col col-6">
		<a href='public-health/timeline'>Explore&#8196;<i class="fas fa-angle-right"></i></a>
	</div>
	<div class="col col-6">
		<a tabindex="0" class="btn btn-sm btn-primary" role="button" data-html="true"
			...
			data-content="
				<a href='public-health/timeline/1'>Daily Patient Count &amp; 7-Day Rolling Average</a> 
				<br>
				<a href='public-health/timeline/2'>Cumlative Patient Count &amp; 7-Day Rolling Average</a>
