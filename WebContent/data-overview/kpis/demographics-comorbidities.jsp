...
<span class="tip">
	<a class="viz_secondary_info" 
		...
		data-toggle="popover" 
		data-placement="top" 
		data-content="<p><strong>Sample:</strong> Patients w/Comorbidities in the N3C Data Enclave</p>
			<small class='kpi-small-note'>Note: Even without filters, this total may be less than the total number of 
			patients with comorbidities within the Enclave due to the suppression of counts less than 20.</small>" 
...
<sql:query var="totals" dataSource="jdbc/N3CPublic">
	...
	from (
		...
		where comorbidity_list is not null
	) y;
</sql:query>
