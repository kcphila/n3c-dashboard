...
<sql:query var="severity" dataSource="jdbc/N3CPublic">
   ...
   FROM ( SELECT severity_abbrev as severity,
           ...
           FROM ( SELECT n3c_dashboard_ph.demo_grouped_cci_cov_csd.severity AS severity,
                    n3c_dashboard_ph.demo_grouped_cci_cov_csd.sex as sex,
                    ...
                    n3c_dashboard_ph.demo_grouped_cci_cov_csd.patient_count AS patient_display,
                        CASE
                            ...
                            ELSE n3c_dashboard_ph.demo_grouped_cci_cov_csd.patient_count::integer
                        END AS patient_count
                   FROM n3c_dashboard_ph.demo_grouped_cci_cov_csd 
                  WHERE n3c_dashboard_ph.demo_grouped_cci_cov_csd.patient_count IS NOT NULL 
                  AND n3c_dashboard_ph.demo_grouped_cci_cov_csd.patient_count <> '<20'::text ) foo
             JOIN n3c_dashboard.age_map_ideal USING (age)
             JOIN n3c_dashboard.race_map USING (race)
             JOIN n3c_dashboard.sex_map USING (sex)
             JOIN n3c_dashboard.sev_map USING (severity)
