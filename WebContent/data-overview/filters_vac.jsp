...
<%@ taglib prefix="util" uri="http://icts.uiowa.edu/tagUtil"%>
	...
	<div class="col col-12 col-md-2 ">
		...
		<div id="filter_checks" class="panel-primary filter-section">
			<h4>Filters:</h4>
			<a id="btn_clear" class=" btn btn-sm dash-filter-btn mt-0 filtered" onclick="uncheckAll();" style="color:white;"><i class="fas fa-times-circle">&nbsp;</i>Reset Filters</a>
			...
			<div class="panel-body">
				<h5 class="filter-drop" id="vaccination"><i class="fas fa-chevron-right"></i> Vaccination</h5>
				<div id="vaccination_panel" style="display:none;">
					Select: <button class="btn btn-light btn-sm" onclick="selectall('vaccination_panel');">All</button>&nbsp;
							<button class="btn btn-light btn-sm" onclick="deselect('vaccination_panel');">None</button>
					<br>
					<input id="vaccination_true" type="checkbox" name="vaccination" value="True"> True
					<br>
					<input type="checkbox" name="vaccination" value="Unknown"> Unknown
				</div>
			</div>
