...
<%@ taglib prefix="util" uri="http://icts.uiowa.edu/tagUtil"%>
	...
	<div class="col col-12 col-md-2 ">
		...
		<div id="filter_checks" class="panel-primary filter-section">
			<h4>Filters:</h4>
			<button id="btn_clear" class="btn dash-filter-btn2 mt-0 filtered" onclick="uncheckAll();"><i class="fas fa-times-circle">&nbsp;</i>Clear Filters</button>
				...
				<div class="accordion" id="vaccination_accordion">
			 		<div class="card">
			 			<div class="card-header" id="vaccination_heading">
							<h2 class="mb-0">
							<button class="filter_drop_button btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#vaccination_body" aria-expanded="true" aria-controls="vaccination_body">
			  					Vaccination
			 				</button>
							</h2>
						</div>
					</div>
					<div id="vaccination_body" class="collapse show" aria-labelledby="vaccination_heading" data-parent="#vaccination_accordion">
						<div class="card-body">
							<div id="vaccination_panel">
								...
								<label class="filter_option"><input id="vaccination_true" type="checkbox" name="vaccination" value="True" > True</label>
