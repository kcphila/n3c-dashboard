...
$.getJSON("<util:applicationRoot/>/overview/collaborating_sites/feeds/${param.feed}", function(data){
	...
	${param.block}_table = $('#${param.target_div}-table').DataTable( {
    	...
    	order: [[0, 'asc']],
     	columns: [
        	{ data: 'project_num', visible: true, orderable: true },
        	{ data: 'project_title', visible: true, orderable: true },
        	{ data: 'ic', visible: true, orderable: true },
        	{ data: 'contact_pi', visible: true, orderable: true },
        	{ data: 'fiscal_year', visible: true, orderable: true },
        	{ data: 'award_amount', visible: true, orderable: true }
    	]
	} );
