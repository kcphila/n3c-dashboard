...
<p>The PDF link in the table retrieves the N3C Collaboration Profile for the respective site.</p>
...
<jsp:include page="../../graph_support/layeredMap.jsp">
	<jsp:param name="layer1" value="/graph_support/map_layers/collaborating_sites.js"/>
</jsp:include>
